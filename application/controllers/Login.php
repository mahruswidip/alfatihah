...
class Login extends CI_Controller
{
  ...
  public function login_mobile()
  {
    ...
    // SELECT *, CASE WHEN record_keberangkatan.created_at > CURDATE() THEN '0' ELSE CONCAT('id_record : ', record_keberangkatan.id_record) END AS id_record, record_keberangkatan.created_at FROM tbl_users LEFT JOIN jamaah ON tbl_users.fk_id_jamaah = jamaah.id_jamaah LEFT JOIN ( SELECT id_jamaah, MAX(created_at) AS max_created_at FROM record_keberangkatan GROUP BY id_jamaah ) AS max_created_at_table ON jamaah.id_jamaah = max_created_at_table.id_jamaah LEFT JOIN record_keberangkatan ON max_created_at_table.id_jamaah = record_keberangkatan.id_jamaah AND max_created_at_table.max_created_at = record_keberangkatan.created_at WHERE tbl_users.user_email = '3579023010810001' AND tbl_users.user_password = '276ba51206df5d73207265d14bed9de1'
