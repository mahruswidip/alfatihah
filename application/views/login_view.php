        ...
        <div class="container">
            <div class="card login-card">
                <div class="row no-gutters">
                    <div class="col-md-5">
                        <img src="<?php echo site_url('assets/images/hero-bg3.jpg'); ?>" alt="login"
                        ...
                        <div class="card-body">
                            <div class="brand-wrapper">
                                <div class="row">
                                    <div class="col-4">
                                        <img class="img-fluid"
                                            src="<?php echo base_url('assets'); ?>/images/logoros.png" alt="">
                                    </div>
                                    <div class="col-4 align-self-center">
                                        <img class="img-fluid" src="<?php echo base_url('assets'); ?>/images/logoal.png"
                                            alt="">
                                    </div>
                                    <div class="col-4 align-self-center">
                                        <img class="img-fluid"
                                            src="<?php echo base_url('assets'); ?>/images/logonip.png" alt="">
                                    </div>
                                </div>
                            </div>
                            <?php
              ...
              ?>
                            ...
                            <p class="login-card-footer-text"><a href="<?= site_url() ?>register/index"
                                    class="text-reset"> </p>
                        </div>
                    </div>
                </div>
